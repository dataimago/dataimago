...
<!-- ###################################### -->
::::::::: {.lenis-slide .dataimago-slide .hero-slide}
<!-- Hero section START -->
::::::: {.hero-section}
...
::: {.logo-container}
![](assets/img/package_hex_logo_grey-light.svg){width=500 .hero-logo}
...
<!-- ###################################### -->
:::::: {.lenis-slide .dataimago-slide .cards-slide}
...
<!-- Logo showcase START -->
::: {.logo-showcase}
![AI Monogram](assets/img/ai_monogram_grey-light.svg){width=60 .showcase-logo}
![Package Logo](assets/img/package_hex_logo_grey-light.svg){width=60 .showcase-logo}
<!-- Logo showcase END -->
:::
...
::: {.learn-more-links}
[**API Reference**](api_reference.qmd)  
